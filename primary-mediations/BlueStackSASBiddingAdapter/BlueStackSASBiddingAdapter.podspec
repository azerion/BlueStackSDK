Pod::Spec.new do |spec|
    ...
    spec.name             = "BlueStackSASBiddingAdapter"
    spec.version          = "4.4.9.1"
    spec.static_framework = true
    spec.summary          = "Equativ bidding adapter used for mediation with the BlueStack SDK"
    ...
    # spec.source           = { :git => "https://github.com/azerion/BlueStackSDK.git", :tag => "#BlueStackSASBiddingAdapter-v{spec.version}" }
    spec.source = { :path => '.' }
    spec.platform = :ios
    spec.swift_version = "5"
    spec.ios.deployment_target  = '12.2'
    spec.vendored_frameworks = 'BlueStackSASBiddingAdapter.xcframework'
