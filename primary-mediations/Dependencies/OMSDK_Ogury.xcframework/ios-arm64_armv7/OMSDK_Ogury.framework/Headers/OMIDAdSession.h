 ...
 */
@interface OMIDOguryAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDOguryAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDOguryAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDOguryAdSessionContext *)context
