Pod::Spec.new do |spec|
    ...
    spec.name             = "BlueStackOguryAdapter"
    spec.version          = "4.4.9.1"
    spec.static_framework = true
    spec.summary          = "Ogury adapter used for mediation with the BlueStack SDK"
    ...
    # spec.source           = { :git => "https://github.com/azerion/BlueStackSDK.git", :tag => "#BlueStackOguryAdapter-v{spec.version}" }
    spec.source = { :path => '.' }
    spec.platform = :ios
    spec.swift_version = "5"
    spec.ios.deployment_target  = '12.2'
    spec.vendored_frameworks = 'BlueStackOguryAdapter.xcframework'
    
    spec.dependency 'BlueStack-SDK/Core', '>= 4.4.9'
    spec.dependency 'OgurySdk', '4.0.0'
