...
SWIFT_CLASS("_TtC12BlueStackSDK17UserAgentProvider")
@interface UserAgentProvider : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UserAgentProvider * _Nonnull shared;)
+ (UserAgentProvider * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)loadAgent;
