...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "GoogleUtilities", url: "https://github.com/google/GoogleUtilities", "7.4.3"..<"7.11.1")
    ],
    targets: [
        ...
        .binaryTarget(name: "MyGoogleUtilities", path: "Dependencies/MyGoogleUtilities.xcframework"),
