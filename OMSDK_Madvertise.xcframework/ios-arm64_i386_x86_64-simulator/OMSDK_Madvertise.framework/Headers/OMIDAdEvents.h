 ...
 */
@interface OMIDMadvertiseAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDMadvertiseAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDMadvertiseVASTProperties *_Nonnull)vastProperties
