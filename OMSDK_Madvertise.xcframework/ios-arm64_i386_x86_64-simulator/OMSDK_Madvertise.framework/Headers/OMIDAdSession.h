 ...
 */
@interface OMIDMadvertiseAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDMadvertiseAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDMadvertiseAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDMadvertiseAdSessionContext *)context
