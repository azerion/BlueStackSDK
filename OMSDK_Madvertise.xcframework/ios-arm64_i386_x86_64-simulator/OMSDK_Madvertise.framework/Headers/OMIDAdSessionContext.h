 ...
 */
@interface OMIDMadvertiseAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDMadvertisePartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDMadvertisePartner *)partner
                               ...
                               resources:(NSArray<OMIDMadvertiseVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
